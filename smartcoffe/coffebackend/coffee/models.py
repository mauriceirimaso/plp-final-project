...
class Coffetable(models.Model):
    ...
    profilephoto = models.ImageField(upload_to='profilepicture/', default='profilepicture/', null=True, blank=True)
...
class Coffeproducts(models.Model):
    ...
    coffephoto = models.ImageField(upload_to='coffephotoes/', default='coffephotoes/', null=True, blank=True)
